  ...
  return (
    <div className="w-full min-h-screen overflow-auto font-sans">
            ...
            {['Vision', 'Mission', 'Values'].map((item) => (
              <motion.div key={item} whileHover={{ scale: 1.05 }}>
                <Link 
                  ...
                  className="text-lg md:text-xl hover:text-gray-200 transition-colors relative group"
                >
                  {item}
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-white transition-all group-hover:w-full"></span>
                </Link>
      ...
      <motion.section
        ...
        className="relative h-screen bg-gradient-to-br from-[#0d47a1] to-[#1a237e] text-white flex flex-col items-center justify-center text-center p-10"
      >
        ...
        >
          ...
          <p className="text-lg leading-[2] text-gray-200">
      ...
      <motion.section
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}
        className="relative min-h-screen flex flex-col items-center justify-center text-center p-10 overflow-hidden"
      >
        ...
        <motion.div 
          ...
          className="relative z-10 max-w-6xl"
        >
          <h3 className="text-3xl font-bold mb-8 text-white">MISSION</h3>
          <p className="text-lg leading-[2] text-gray-100">
      ...
      <motion.section
        ...
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true, amount: 0.3 }}
        className="relative min-h-screen bg-gradient-to-br from-[#0d47a1] to-[#1a237e] text-white flex flex-col items-center justify-center text-center p-10"
      >
        <ConstellationBackground customWidth={true} />
        <motion.div 
          initial={{ y: 20, opacity: 0 }}
          ...
          className="relative z-10 max-w-6xl"
        >
          <h3 className="text-3xl font-bold mb-8">VALUES</h3>
          <p className="text-lg leading-[2] text-gray-200">
