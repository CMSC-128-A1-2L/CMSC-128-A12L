...
export default function AboutPage() {
  ...
  return (
    <div className="w-full min-h-screen overflow-auto font-sans">
      ...
      <motion.section
        ...
        className="relative h-screen w-full flex items-center justify-center text-center bg-[#1a237e] px-4 md:px-4"
      >
        {/* <ConstellationBackground /> */}
         ...
         <video
          ...
          muted
          playsInline
          className="brightness-50 contrast-117 absolute inset-0 w-full h-full object-cover z-0"
        >
  ...
  <path
    d="M11.50 28.30L21.80 28.30L22.15 29.25L10.75 29.25L11.50 28.30 ... etc"
    fill="black"
    opacity="0.2"
  ...
  />
          ...
          <h2 className="text-2xl md:text-4xl font-bold mb-8"  style={{
              textShadow: '1px 1px 2px rgba(0,0,0,0.8), -1px -1px 2px rgba(255,255,255,0.2)'
            }}>
