        ...
        <div className="w-full min-h-screen overflow-auto font-sans">
            ...
            >
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h1 className="text-center text-3xl md:text-4xl font-bold text-white mb-8">Terms of Service</h1>
                        
                        <div className="space-y-6 text-gray-200">
                            <section>
                                <h2 className="text-xl font-semibold text-white mb-4">1. Acceptance of Terms</h2>
                                <p className="leading-relaxed">
                                    By accessing and using the Alumni Engagement Gateway and Information System, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="leading-relaxed">
                                    To access certain features of the platform, you must register for an account. You agree to provide accurate and complete information during registration and to update such information to keep it accurate and current.
                                </p>
                            </section>

                            <section>
                                <h2 className="text-xl font-semibold text-white mb-4">4. Privacy Policy</h2>
                                <p className="leading-relaxed">
                                    Your use of the platform is also governed by our Privacy Policy, which is incorporated into these Terms of Service by reference.
                                </p>
                            </section>
                            ...
                            <section>
                                <h2 className="text-xl font-semibold text-white mb-4">7. Revisions and Errata</h2>
                                <p className="leading-relaxed">
                                    The materials appearing on our platform could include technical, typographical, or photographic errors. We do not warrant that any of the materials on our platform are accurate, complete, or current.
                                </p>
                            </section>
