	...
	return (
	  ...
	  >
		...
		>
			...
			{/* Description */}
			<p
			  className="mt-20 text-xs md:text-sm text-center md:text-left w-full md:w-5/5  md:mt-[-1px] ml-4 md:ml-10 "
			...
			{/* Support Text */}
			<p
			  className="mt-4 text-xs md:text-sm text-center md:text-left text-gray-500 md:w-4.5/5 ml-4 md:ml-10"
