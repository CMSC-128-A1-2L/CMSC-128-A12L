...
export default function DeleteUser({ name }) {
    ...
    return(
        <>
        <button onClick={handleModal} className="btn bg-[#0C0051] text-white hover:bg-[#12006A]" style={{ fontFamily: "Montserrat, sans-serif", fontSize: "15px", cursor: "pointer"}}>Delete</button>
        {openModal &&
