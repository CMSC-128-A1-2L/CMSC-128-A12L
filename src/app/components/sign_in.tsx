  ...
  return (
    <div className="space-y-3">
      <motion.button
        ...
        tabIndex={3}
        className="w-full bg-white text-gray-700 py-3 px-4 rounded-lg flex items-center justify-center gap-3 shadow-sm hover:shadow-md border border-gray-200 transition-all duration-200 hover:bg-gray-50"
