...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* Right Panel - Light */}
      <div className="w-full lg:w-1/2 bg-[#f8f9fc] flex flex-col items-center justify-center p-4 lg:p-8 relative">
        {/* Mobile Logo - Only visible on mobile */}
        <div className="lg:hidden w-24 h-24 mx-auto mb-4">
          <svg viewBox="0 14.3 135.35 32.5" className="w-full h-full text-[#1a1f4d]">
            <motion.path
              initial={{ pathLength: 0 }}
              animate={{ pathLength: 1 }}
              transition={{ duration: 4, ease: "easeInOut" }}
        ...
        {/* Back Button and Create Account Section */}
