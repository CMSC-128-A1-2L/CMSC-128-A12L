    ...
    <div className="w-full min-h-screen overflow-auto font-sans">
      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 mb-8 text-sm md:text-base">Join our alumni community and stay connected.</p>
          <motion.div
          ...
          >
            <Link href="/register" className="w-full md:w-auto">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full bg-white text-[#0c0151] px-8 py-3 rounded-md font-semibold hover:bg-gray-100 transition-colors cursor-pointer border-2 border-transparent"
              >
                Create Account
              </motion.button>
            </Link>
            <Link href="/login" className="w-full md:w-auto">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white/10 transition-colors cursor-pointer"
              >
                Log In
              </motion.button>
            </Link>
      ...
      <motion.section 
        ...
        transition={{ duration: 1 }}
        viewport={{ once: true }}
        className="relative p-8 md:p-16 min-h-[90vh] flex flex-col justify-center overflow-hidden"
      >
      ...
      <motion.section 
        ...
        transition={{ duration: 1 }}
        viewport={{ once: true }}
        className="relative bg-gradient-to-br from-[#0d47a1] to-[#1a237e] text-white p-8 md:p-16 min-h-[90vh] flex flex-col justify-center"
      >
        <ConstellationBackground />
