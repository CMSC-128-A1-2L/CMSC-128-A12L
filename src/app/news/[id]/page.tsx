...
export default function NewsDetailsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br  from-[#1a237e] to-[#0d47a1] text-white p-8">
        <div className="max-w-6xl mx-auto">
          <div className="animate-pulse">
            <div className="h-8 w-1/4 bg-white/20 rounded mb-8"></div>
            <div className="h-96 w-full bg-white/20 rounded mb-8"></div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#1a237e] to-[#0d47a1] text-white p-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">The requested news article could not be found.</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a237e] to-[#0d47a1] text-white">
            {/* Navbar */}
    <motion.nav 
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      <main className="pt-24 pb-16 px-4 mt-15">
        <div className="max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
